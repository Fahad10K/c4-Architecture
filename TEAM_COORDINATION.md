...
| **iOS App** | `feature/ios-app` | � COMPLETE | Chat 3 |
...
| Date | Update |
|------|--------|
| 2025-05-20 | Created `feature/ios-app` branch, full iOS app implemented |
| 2025-05-20 | Tech: Swift 5.9 + SwiftUI + MVVM + NavigationStack + Starscream WebSocket |
| 2025-05-20 | All screens complete: Auth, Home, Stores, Menu, Cart, Checkout, Orders, Tracking, Notifications, Chatbot, Search, Profile, Admin |
| 2025-05-20 | Connects to shared backend at `http://localhost:3001/api/v1` |
| 2025-05-20 | WebSocket for real-time delivery tracking and chatbot |
| 2025-05-20 | iOS 17+ target, SPM package with Starscream dependency |
